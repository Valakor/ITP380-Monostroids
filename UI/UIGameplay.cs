...
namespace itp380.UI
{
	public class UIGameplay : UIScreen
	{
		...
		{	
            ...
            DrawBatch.DrawString(m_StatusFont, "Lives: " + GameState.Get().Lives.ToString(), new Vector2(5, 710), Color.White);

            DrawBatch.DrawString(m_StatusFont, "Score: " + GameState.Get().Score.ToString(), new Vector2(750, 710), Color.White);
		}
